site.reactjs.CallCenterSupervisor.DistributionHouses = React.createClass({
            ...
            <div className="row">
                ...
                <div className="col-md-12">
                    ...
                    <BootstrapTable data={_rows} striped={true} hover={true} height={$this.state.height}>
                        <TableHeaderColumn dataField="DISTRIBUTION_HOUSE_ID"
                                           isKey={true}>DISTRIBUTION_HOUSE_ID</TableHeaderColumn>
                        <TableHeaderColumn dataField="DISTRIBUTION_HOUSE_NAME"
                                           dataFormat={function (cell, row) {
                                                return <a href={'#/brs?BRS.DISTRIBUTION_HOUSE_ID=' + row['DISTRIBUTION_HOUSE_ID']}>{cell}</a>;
                                           }}
                            >DISTRIBUTION_HOUSE_NAME</TableHeaderColumn>
    ...
    getData: function (params) {
        ...
        var eq = [convert(params, {
            'DISTRIBUTION_HOUSES.AREA_ID': function (val) {
                return parseInt(val);
            }
        })];
        ...
        eb.send('DISTRIBUTION_HOUSE_WISE_CALL_SUMMARY', {eq: eq}, {}, function (err, msg) {
